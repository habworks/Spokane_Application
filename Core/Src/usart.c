...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB5     ------> UART5_CTS
    */
    HAL_GPIO_DeInit(LTE_U5_TX_GPIO_Port, LTE_U5_TX_Pin);

    HAL_GPIO_DeInit(LTE_U5_RX_GPIO_Port, LTE_U5_RX_Pin);

    HAL_GPIO_DeInit(GPIOB, LTE_U5_RTS_Pin|LTE_U5_CTS_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC5     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, NXP_TX_Pin|NXP_RX_Pin);
